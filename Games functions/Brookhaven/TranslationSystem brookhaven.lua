...
function TranslationModule:GetTabs()
    ...
    if getgenv().RaelHubAutoTranslator and currentLanguage == "pt" then
      ...
      local Clothes = {  
        ...
        section4 = "Copiar a skin dos jogadores",
        sectionInvsible = "Avatar invisível",
        ...
        buttonInvisible = "Ficar invisível",
      ...
      local Clothes = {  
        ...
        section4 = "Copy player skin",
        sectionInvsible = "Invisible Avatar",
        ...
        buttonInvisible = "Become invisible",  
